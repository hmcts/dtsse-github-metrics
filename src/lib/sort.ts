 ...
 */
export function nextDirection<Column>(active: Column | null, next: Column, direction: Direction): Direction {
...
export function sorted<Row>(rows: readonly Row[], read: (row: Row) => SortValue, direction: Direction): Row[] {
